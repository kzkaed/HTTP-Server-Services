...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=kzkaed_web-server&metric=alert_status)](https://sonarcloud.io/summary/overall?id=kzkaed_web_server)
