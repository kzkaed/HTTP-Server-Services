...
public class HtmlViewTest {
	...
	public void testBuildsTemlplateBasedOnDirectoryType(){
		...
		assertEquals(html.build(),"<!doctype html><html><head></head><body>Directory<br><a href=\"an item\">an item</a><br></body></html>");
	}
	...
	public void testBuildsTemlplateBasedOnParmetersType(){
		...
		assertEquals(html.build(),"<!doctype html><html><head></head><body>variable_1 = param1 valuevariable_2 = null</body></html>");
	}
